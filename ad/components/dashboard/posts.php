...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><?php get_inactive_posts()?></h3>
                <p>Total InActive Posts</p>
            </div>
            <div class="icon">
                <i class="fas fa-layer-group"></i>
            </div>
            <a href="posts/inactivepost" target="_blank" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-6">
        <div class="small-box bg-dark">
            <div class="inner">
                <h3><?php get_total_schedules()?></h3>
                <p>Total Scheduled Posts</p>
            </div>
            <div class="icon">
                <i class="fas fa-layer-group"></i>
            </div>
            <a href="posts/schedule_post" target="_blank" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-3 col-6">
        <div class="small-box bg-pink">
            <div class="inner">
                <h3><?php get_total_drafts()?></h3>
                <p>Total Saved Posts</p>
            </div>
            <div class="icon">
                <i class="fas fa-layer-group"></i>
            </div>
            <a href="posts/drafts" target="_blank" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo get_total_post_this_year() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo get_total_post_this_month() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo get_total_post_this_week() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo get_total_post_today() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                  <table class="table m-0 table-striped table-bordered table-dark">
                    ...
                    <tbody>
                        <?php
                        $get_latest_10_posts=get_latest_10_posts();
                        while($cat_row=mysqli_fetch_assoc($get_latest_10_posts)){
                            $id = $cat_row['id'];
                            $name = $cat_row['title'];
                            $date = $cat_row['date2'];
                            $time = $cat_row['time'];
            ...
            <div class="card-footer text-center">
                <a href="posts/post" class="uppercase" style="color: #c5298e">View All Posts</a>
            </div>
        </div>
    </div>
</div>