<?php 
require('../header.php') ;
require('../form_submit/categories/b_categories_add.php');
?>
                ...
                <form method="post">
                  <div class="row">
                      <div class="col-8 form-group juji">
                          <label >Title</label>
                          <input type="text" id="title" name="title" value="" class="form-control" placeholder="Title" required>
                      </div>
                      <div class="col-4 form-group juji">
                          ...
                          <input id="pickeric" name="pickeric" type="hidden" value="fas fa-heart">
                      </div>
                      <div class="col-12 form-group juji">
                          <label >Description</label>
                          <textarea id="description" name="description" class="form-control" placeholder="Decription" rows="5"></textarea>
                      </div>
                      ...
                      <div class="col-12 form-group juji">
                          <label >Title</label>
                          <input type="text" id="seo_title" name="seo_title" value="" class="form-control" placeholder="Title">
                      </div>
                      <div class="col-12 form-group juji">
                          <label >Description</label>
                          <textarea id="seo_description" name="seo_description" class="form-control" placeholder="Decription" rows="3"></textarea>
                      </div>
                      <div class="col-12 form-group juji">
                          <label >Keywords</label>
                          <textarea id="seo_keywords" name="seo_keywords" class="form-control" placeholder="Keywords" rows="3"></textarea>
