<?php 
require('../header.php');
require('../fetchers/post/fetch_edit_draft.php');
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Saved Post</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Saved Post</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-primary card-outline loko">
                    ...
                    <div class="card-header headreplt">
                        ...
                        <a class="btn btn-secondary" href="draft"><i class="fas fa-hand-point-left"></i> Back To Drafts</a>
                        </div>
                        <div class="mr-10">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                                ...
                                <div class="contscroller">
                                    <div class="col-12 form-group juji">
                                        ...
                                        <input class="d-none" id="site_pather2" value="<?php echo SITE_PATH_ADMIN.'posts/drafts' ?>" />
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 vlexcaol">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <input name="schedule_post" class="d-none" id="schedule_post" value="<?php echo $schedule_post ?>"/>
                                    <input name="allsave" class="d-none" id="allsave_draft" value="1"/>
                                    <input name="allsaveid" class="d-none" id="allsave_id" value="<?php echo $idDraft ?>"/>
