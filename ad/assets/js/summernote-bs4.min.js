          ...
          i.a.summernote = i.a.summernote || {
             ...
             "en-US": {
                ...
                image: {
                   ...
                   url: "<i class='fas fa-external-link-alt'></i> Choose image from URL link",
                   remove: "Remove Image",
                   original: "Original"
                },
                video: {
                ...
                value: function (t, e) {
                   ...
                   return (n = t, i.a.Deferred((function (t) {
                      ...
                      e.one("load", (function () {
                        ...
                        var colDert = document.getElementById('schedule_postxxxxxx').value;
                        colDert = colDert.trim();
                      o.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", '100%')), t.attr('title',colDert), t.attr('alt',colDert), t.show(), o.getLastRange().insertNode(t[0]), o.setLastRange(wt.createFromNodeAfter(t[0]).select()), o.afterCommand()
                   })).fail((function (t) {
             ...
             return e = t, (n = [{
                ...
                value: function () {
                   ...
                   var o = this.options.dialogsInBody ? this.$body : this.options.container,
                      i = ['<div class="classeredit"><span onclick="ifrmaerClick()" class="btn btn bxvcz btn-primary"><i class="fas fa-image"></i> Choose from gallery</span> <span onclick="uploaderClick()" class="btn btn bxvcz btn-dark"><i class="fas fa-desktop"></i>  Upload from your computer</span></div>', '<div class="form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + "</label>", '<input id="note-dialog-image-url-' + this.options.id + '" class="noteibileedited note-image-url form-control note-form-control note-input" type="text"/>', "</div>"].join(""),
          ...
          var s = r.a.create('<div class="note-editor note-frame card"/>'),
             ...
             y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function (t, e) {
                e.fade && t.addClass("fade"), t.attr({
                   "aria-label": e.title
                }), t.html(['<div class="modal-dialog">', '<div class="modal-content">', e.title ? '<div class="modal-header"><h4 class="modal-title">' + e.title + '</h4><button id="closerModal" type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>' : "", '<div class="modal-body">' + e.body + "</div>", e.footer ? '<div class="modal-footer">' + e.footer + "</div>" : "", "</div>", "</div>"].join(""))
             })),
